...
<head>
    ...
    <title>DUCATI CORSE | Thêm Bản Ghi Mới</title>
...
<body class="bg-dark text-white">
    ...
    <main class="admin-main">
        ...
        <header class="mb-5">
            <h2 class="font-heading text-uppercase fw-bold m-0 fs-3">Thêm Bản Ghi Mới</h2>
            <p class="text-secondary mt-1">Khởi tạo các thuộc tính dữ liệu mới trong hệ thống.</p>
        </header>
        ...
        <section class="card card-ducati p-4 mb-4 racing-stripe">
            <form action="${pageContext.request.contextPath}/admin/list.jsp" method="post" enctype="multipart/form-data" class="needs-validation-custom" novalidate>
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="txtName" id="txtName" class="form-control bg-black border-secondary text-white rounded-0" placeholder="Nhập tên bản ghi..." required type="text"/>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="txtDescription" id="txtDescription" rows="4" class="form-control bg-black border-secondary text-white rounded-0" placeholder="Nhập mô tả..." required></textarea>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            <label for="fileImage" class="form-label font-heading text-uppercase small text-muted">Hình ảnh minh họa</label>
                            <input name="fileImage" id="fileImage" class="form-control bg-black border-secondary text-white rounded-0" type="file" accept="image/*" required/>
                            <div class="invalid-feedback font-mono-data uppercase" style="font-size: 10px;">Vui lòng chọn một tập tin hình ảnh.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border border-secondary bg-black bg-opacity-50 d-flex align-items-center justify-content-center overflow-hidden position-relative" style="height: 180px;">
                                <img id="imagePreview" src="" alt="Image Preview" class="img-fluid d-none" style="max-height: 100%; object-fit: contain;"/>
                                <span id="previewPlaceholder" class="text-muted font-mono-data small uppercase">Chưa chọn ảnh</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-top border-secondary pt-4 mt-4 d-flex justify-content-end gap-3">
                    ...
                    <button type="submit" class="btn btn-ducati rounded-0 font-mono-data text-uppercase small py-2 px-4">Khởi tạo</button>
                </div>
            </form>
        </section>
