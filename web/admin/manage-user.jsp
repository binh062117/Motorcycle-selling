...
<body class="bg-background text-on-background font-body-md overflow-x-hidden">
    ...
    <aside class="fixed left-0 top-0 h-full w-64 bg-surface-container-lowest border-r border-surface-variant z-50 flex flex-col py-8">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <!-- Active State: User Management -->
            <a class="flex items-center gap-4 bg-primary-container text-white border-l-4 border-primary px-6 py-3 transition-colors font-mono-data text-mono-data uppercase" href="${pageContext.request.contextPath}/admin/manage-user.jsp">
    ...
    <main class="ml-64 min-h-screen p-margin-desktop bg-background">
        ...
        <header class="mb-12">
            <h2 class="font-headline-lg text-headline-sm md:text-headline-lg uppercase tracking-tight text-white font-extrabold">Quản Lý Phân Quyền Người Dùng</h2>
            <p class="font-body-md text-on-surface-variant mt-1">Điều tiết chức năng truy cập tài khoản trong hệ thống quản trị và mua hàng.</p>
        </header>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-surface-container font-label-md text-label-md uppercase text-on-surface-variant border-b border-surface-variant">
                        <th class="px-6 py-4 font-semibold w-1/6">Mã tài khoản</th>
                        <th class="px-6 py-4 font-semibold">Tên họ người dùng</th>
                        <th class="px-6 py-4 font-semibold">Địa chỉ Email</th>
                        <th class="px-6 py-4 font-semibold">Số điện thoại</th>
                        <th class="px-6 py-4 font-semibold">Vai trò phân quyền</th>
                        <th class="px-6 py-4 font-semibold text-right">Thay đổi vai trò</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-surface-variant/30">
                    
                    <tr class="hover:bg-surface-container-low transition-colors group">
                        <td class="px-6 py-6 font-bold text-white group-hover:text-primary-container">#ACC-887711</td>
                        <td class="px-6 py-6 font-bold text-white text-[15px]">Enzo Ferrari</td>
                        <td class="px-6 py-6 uppercase text-on-surface-variant">enzo@ferrari.it</td>
                        <td class="px-6 py-6 font-semibold">0912345678</td>
                        <td class="px-6 py-6">
                            <span class="px-3 py-1 bg-surface-variant/50 text-[#c6c6c6] uppercase text-[12px] font-bold">Khách hàng</span>
                        </td>
                        <td class="px-6 py-6 text-right">
                            <form action="${pageContext.request.contextPath}/admin/manage-user" method="post" class="inline-block">
                                <input type="hidden" name="accountId" value="887711"/>
                                <select name="txtRole" onchange="this.form.submit()" class="bg-black border border-surface-variant text-on-surface text-xs font-mono-data px-4 py-2 outline-none uppercase cursor-pointer focus:ring-0">
                    ...
                    <tr class="hover:bg-surface-container-low transition-colors group">
                        <td class="px-6 py-6 font-bold text-white group-hover:text-primary-container">#ACC-443322</td>
                        <td class="px-6 py-6 font-bold text-white text-[15px]">Valentino Rossi</td>
                        <td class="px-6 py-6 uppercase text-on-surface-variant">rossi46@motogp.it</td>
                        <td class="px-6 py-6 font-semibold">0987654321</td>
                        <td class="px-6 py-6">
                            <span class="px-3 py-1 bg-primary-container/20 text-primary-container uppercase text-[12px] font-bold">Quản trị viên</span>
                        </td>
                        <td class="px-6 py-6 text-right">
                            <form action="${pageContext.request.contextPath}/admin/manage-user" method="post" class="inline-block">
