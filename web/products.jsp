...
<main class="py-5 container-fluid px-4 max-w-container-max mx-auto">
    <div class="row g-4">
        <aside class="col-12 col-lg-3">
            <form action="${pageContext.request.contextPath}/products" method="get" class="products-filter-panel d-flex flex-column gap-4">
                <div class="filter-section card card-ducati p-4 racing-stripe">
                    <h2 class="font-heading text-uppercase tracking-wider fs-6 text-danger mb-4 fw-bold"><fmt:message key="products.brand" /></h2>
                    <div class="filter-scroll-list d-flex flex-column gap-3">
                ...
                <div class="filter-section card card-ducati p-4">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card card-ducati h-100 overflow-hidden position-relative group">
                            <div class="bike-image-stage">
                                <img class="w-100 h-100 bike-product-img" src="${pageContext.request.contextPath}/${product.imageUrl}" alt="${product.name}" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/assets/img/product-placeholder.svg';"/>
