...
<head>
    ...
    <title>DUCATI SHOWROOM | 403 Forbidden</title>
...
<body class="bg-dark text-white d-flex align-items-center justify-content-center min-vh-screen" style="min-height: 100vh;">
    ...
    <div class="card card-ducati p-5 text-center racing-stripe" style="max-width: 480px;">
        ...
        <h1 class="font-heading display-1 fw-black text-danger mb-3" style="font-weight: 900;">403</h1>
        <h2 class="font-heading text-uppercase text-white fs-4 mb-3">TRUY CẬP BỊ TỪ CHỐI</h2>
        <p class="text-secondary small leading-relaxed mb-4">
            Tài khoản của bạn không có đủ đặc quyền cần thiết để truy cập vào tài nguyên hoặc trang điều hành quản trị này.
        </p>
